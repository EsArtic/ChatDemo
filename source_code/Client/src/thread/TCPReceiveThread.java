...
/**
 * The thread to receive the TCP packets and handle them.
 */
public class TCPReceiveThread implements Runnable {
    ...
    /**
     * Initialize the Socket and BufferedReader.
     * @param s Socket reference from Client class
     */
    ...
    /**
     * Analyze the given idList and nameList and build the online user Map.
     * @param idList the list contains online user's ID
     * @param nameList the list contains online user's name
     */
